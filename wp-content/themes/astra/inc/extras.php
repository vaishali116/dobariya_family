...
if ( ! function_exists( 'astra_site_branding_markup' ) ) {
	...
	function astra_site_branding_markup() {
		...
		<div class="custom_sizer_photos">
			<div class="innerphotos">
				<img src="http://www.khodaldhamtrust.org/albums/element_576_jaysardar.png" alt="Jay Sardar" width="89px" height="109px">
				<img src="http://www.khodaldhamtrust.org/albums/element_576_jaysardar.png" alt="Jay Bhojalram" width="89px" height="109px">
			</div>
		</div>
