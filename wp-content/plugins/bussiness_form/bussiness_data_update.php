...
function bussiness_data_update() {
    global $wpdb;
...
//delete
        ...
        $business = $wpdb->get_results($wpdb->prepare("SELECT * from $table_name where id=%s", $id));
        foreach ($business as $s) {
            $register_as = $s->register_as;
            ...
            $email = $s->email;
            $bussiness_category = $s->bussiness_category;
            $website = $s->website;
        }
    }
    ?>
    ...
    <div class="wrap">
        ...
        <?php } else if ($_POST['update']) { ?>
            <div class="updated"><p>Business updated</p></div>
            <a href="<?php echo admin_url('admin.php?page=bussiness_data_list') ?>">&laquo; Back to data list</a>
